...
SRC_TARGET = "data/Videos/square_to_circle(black).mp4"

START_TRAINING_FROM_SAVE_POINT = False
SAVE_POINT = 7000 # step

EXPERIMENT_TYPE = "TBD" #@param ["Growing", "Persistent", "Regenerating", "Roll"]
...
EXPERIMENT_MAP = {"Growing":0, "Persistent":1, "Regenerating":2, "Roll": 3, "TBD": 4}
